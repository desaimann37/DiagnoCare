...
const LungCancerForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      if (!formData.Age || !formData.AirPollution || !formData.ClubbingofFingerNails || !formData.DryCough || !formData.Fatigue || !formData.FrequentCold || !formData.Gender || !formData.ShortnessofBreath || !formData.Smoking|| !formData.SwallowingDifficulty|| !formData.WeightLoss|| !formData.Wheezing) {
        Swal.fire({
          icon: "error",
          title: "Error",
  ...
  const handleUploadPDF = async(pdfData) => {
    ...
    const filename = `${combinedData.patient_details.name}_LungCancerReport.pdf`;
  ...
  const handleDownloadPDF = async () => {
    ...
    const tableData = [
      ...
      { header: "Gender:", content: formData.Gender },
      { header: "Disease name:", content: "Lung Cancer" },
      { header: "AirPollution:", content: formData.AirPollution },
      { header: "Smoking:", content: formData.Smoking },
      { header: "Fatigue:", content: formData.Fatigue },
      { header: "WeightLoss:", content: formData.WeightLoss },
      { header: "ShortnessofBreath:", content: formData.ShortnessofBreath },
      { header: "Wheezing:", content: formData.Wheezing },
      { header: "SwallowingDifficulty:", content: formData.SwallowingDifficulty },
      { header: "ClubbingofFingerNails:", content: formData.ClubbingofFingerNails },
      { header: "FrequentCold:", content: formData.FrequentCold },
      { header: "DryCough:", content: formData.DryCough },
    ...
    doc.autoTable({
     ...
     doc.save(combinedData.patient_details.name + "_LungCancerReport.pdf");
  };
  ...
  return (
    <>
      ...
      <div className="d-form-text-section">
        <h1 className="fs-10 mb-5 align-items-center">Lung Cancer</h1>
      </div>
              ...
              >
                ...
                <div className="mb-3 d-flex">
                  <div className="mr-3 flex-grow-1">
                    ...
                    />
                    <div className="invalid-feedback">
                      Swallowing Difficulty is required
                    </div>
                  </div>
                  ...
                  <div className="flex-grow-1">
                    ...
                    />
                    <div className="invalid-feedback">
                      Clubbing of FingerNails is required
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-3 d-flex">
                  <div className="mr-3 flex-grow-1">
                    ...
                    />
                    <div className="invalid-feedback">
                      Frequent Cold Difficulty is required
                    </div>
                  </div>
